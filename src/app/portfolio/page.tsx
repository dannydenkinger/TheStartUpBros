  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <section className="px-6 lg:px-10 pt-[140px] pb-[60px] text-center flex flex-col items-center justify-center">
        ...
        <h1 className="text-display mt-8 mb-4">Design <span style={{ color: 'var(--accent-brand)' }}>Gallery</span></h1>
        ...
        <h1 className="text-display max-w-[900px] mx-auto text-foreground font-medium">
          Design <span style={{ color: 'var(--accent-brand)' }}>Studies</span> — B2B &amp; AI SaaS Deep-Dives
        </h1>
      </section>
