# StartUpBros account setup launchpad

This is the click-through handoff for the accounts assigned to Anthony and Codex. Danny owns the credentials and final submission for every account.
...
| --- | --- |
| Company name | **StartUpBros** |
| Public category | **MVP development studio** |
| Preferred username/handle | **startupbrosstudio** |
| Backup username/handle | **buildwithstartupbros** |
| Signup email | **thestartupbros1@gmail.com** |
| Current website | **https://the-start-up-bros.vercel.app** |
| Founders | **Anthony Denkinger and Danny Denkinger** |
| Location served | **United States** |

Use `StartUpBros` as the company or Page name. Do not use `StartUpBros MVP Studio` as the legal or company name; place `MVP development studio` in the category, headline, or bio field instead.

### Short bio

> Founder-led MVP studio. We design and build launch-ready web apps, SaaS products, and AI tools in focused 2–4 week engagements.

### One-line description

> StartUpBros helps startups design and build launch-ready web apps, SaaS products, AI integrations, and internal tools.

### Long description

> StartUpBros is a founder-led MVP and product studio founded by brothers Anthony and Danny Denkinger. We help early-stage teams scope, design, and build launch-ready web apps, SaaS products, AI integrations, and internal tools. Clients work directly with the founders, receive full code handover, and can continue with updates and maintenance after launch.

### Categories and keywords

Use the closest options each platform provides:
...
- [StartUpBros social banner](https://raw.githubusercontent.com/dannydenkinger/TheStartUpBros/development/public/og.png)
- [Anthony Denkinger headshot](https://raw.githubusercontent.com/dannydenkinger/TheStartUpBros/development/public/images/avatars/anthony-denkinger.png)
- [Danny Denkinger headshot](https://raw.githubusercontent.com/dannydenkinger/TheStartUpBros/development/public/images/avatars/danny-denkinger.png)
...
4. Open [Create a Crunchbase profile](https://www.crunchbase.com/add-new) and choose **Organization**.
5. Use these public details:
   - Organization name: **StartUpBros**
   - Website: `https://the-start-up-bros.vercel.app`
   - Description: use the **Long description** above
   - Industries: use the closest **Categories and keywords** above
   - Founders: **Anthony Denkinger** and **Danny Denkinger**
   - Location served: **United States**
...
3. The account must be a real personal maker account:
   - Full name: **Danny Denkinger**
   - Username: **dannydenkinger** if available
   - Profile photo: use the **Danny Denkinger headshot** above
   - Bio: **Co-founder of StartUpBros. We design and build launch-ready web apps, SaaS products, and AI tools.**
   - Website: `https://the-start-up-bros.vercel.app`
4. Do not name the personal account StartUpBros. Product Hunt blocks branded accounts from posting, commenting, and voting.
5. After the personal account is at least one week old, open [Submit a product](https://www.producthunt.com/posts/new) and create the product page under the company name **StartUpBros**.
...
Do not guess or publish any of the following while creating profiles:

- Legal company name or entity type
- Founding date
- Headquarters or street address
- Employee, customer, revenue, funding, or valuation numbers
- Pricing or offer changes
- Client names, testimonials, or other public proof not already approved
- Custom domain until ownership and billing are confirmed

The current Vercel URL is the approved website placeholder. Replace it across the profiles only after the custom domain is purchased and connected.
